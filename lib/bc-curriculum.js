...
export const SUBJECT_SLUG_MAP = {
  ...
  // 'French' intentionally omitted: French uses a different URL pattern
  // (curriculum.gov.bc.ca/curriculum/languages/{grade}/core-french) than
  // the simple {subject}/{grade}/core pattern every other subject follows
  // - needs its own handling, not built yet. getCurriculum() returns null
  // gracefully for unmapped subjects rather than guessing a wrong URL.
