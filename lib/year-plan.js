...
export const LENS_TEMPLATES = {
  standards_based: {
    periods: [
      { label: 'Geography & Human Systems', pct: 20 },
      { label: 'Cells, Body Systems & Science Foundations', pct: 20 },
      { label: 'Heat, Energy & Forces', pct: 20 },
      { label: 'Numeracy Progression (Fractions, Algebra, Geometry, Data)', pct: 20 },
      { label: 'Global Issues, Civilizations & Sustainability', pct: 20 },
    ],
  },
  competency_based: {
    periods: [
 ...
 */
export function defaultPeriodsForModel(modelKey) {
